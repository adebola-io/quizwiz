      ...
      <div className={className}>
         <div className="flex items-center overflow-hidden h-full w-full justify-between max-[768px]:justify-center max-[720px]:justify-start max-[768px]:gap-[8%] pl-[--home-card-left-padding] pr-[1.8rem] max-[1024px]:pr-[1rem] max-[768px]:pl-2 max-[720px]:pl-[2rem] max-[540px]:pl-[1rem] bg-white relative border-[5px] max-[768px]:border-[4px] max-[720px]:border-[6px] max-[540px]:border-[4px] border-green-charcoal border-solid rounded-[1.1rem] max-[768px]:rounded-[0.9rem] max-[414px]:rounded-[0.5rem]">
            <div className="flex flex-col">
               <span className="text-[4.6rem] max-[1366px]:text-[3rem] max-[1024px]:text-[2.5rem] max-[768px]:text-[2.5rem] max-[720px]:text-[6rem] max-[540px]:text-[3rem] whitespace-nowrap [text-wrap:nowrap] leading-[1.3] max-[720px]:leading-[1] font-avenir-next-lt-pro-bold">
                  {props.value}{" "}
                  {props.percent && (
                     <span className="inline-block translate-x-[-9px] text-[3rem] max-[1024px]:text-[1.5rem] max-[768px]:w-0 max-[720px]:text-[2rem]">
                        %
                     </span>
                  )}
               </span>
               <span className="font-poppins text-[1.30406rem] max-[1024px]:text-[0.9rem] max-[768px]:hidden max-[720px]:block max-[720px]:text-[2rem] max-[540px]:text-[1.3rem] font-bold">
                  {props.name}
               </span>
            </div>
            {props.icon}
