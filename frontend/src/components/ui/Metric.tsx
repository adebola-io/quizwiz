...
export function Metric(props: MetricProps) {
   const className = clsxm(
      ...
      ...[
         "before:block before:absolute before:[content:''] before:rounded-[1.1rem] before:max-[768px]:rounded-[0.9rem] before:max-[414px]:rounded-[0.5rem] before:min-[2160px]:rounded-[2rem] before:w-full before:h-full before:duration-500",
         "before:border-green-charcoal before:border-[5px] before:max-[768px]:border-[4px] before:max-[720px]:border-[6px] before:max-[540px]:border-[4px] before:min-[2160px]:border-[8px] before:border-solid",
   ...
   return (
      <div className={className}>
         <div className="flex items-center overflow-hidden h-full w-full justify-between max-[768px]:justify-center max-[720px]:justify-start max-[768px]:gap-[8%] pl-[--home-card-left-padding] pr-[1.8rem] max-[1024px]:pr-[1rem] max-[768px]:pl-2 max-[720px]:pl-[2rem] max-[540px]:pl-[1rem] bg-white relative border-[5px] max-[768px]:border-[4px] min-[2160px]:border-[8px] max-[720px]:border-[6px] max-[540px]:border-[4px] border-green-charcoal border-solid rounded-[1.1rem] min-[2160px]:rounded-[2rem] max-[768px]:rounded-[0.9rem] max-[414px]:rounded-[0.5rem]">
            <div className="flex flex-col">
               <span className="text-[4.6rem] min-[2160px]:text-[5.6rem] min-[1900px]:text-[5.2rem] max-[1366px]:text-[3rem] max-[1024px]:text-[2.5rem] max-[768px]:text-[2.5rem] max-[720px]:text-[6rem] max-[600px]:text-[4rem] max-[540px]:text-[3rem] max-[290px]:text-[1.5rem] whitespace-nowrap [text-wrap:nowrap] leading-[1.3] max-[720px]:leading-[1] font-avenir-next-lt-pro-bold">
                  {props.value}{" "}
                  {props.percent && (
